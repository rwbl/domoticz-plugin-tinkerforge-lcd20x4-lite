...
# Objectives
* To write characters to the Tinkerforge LCD 20x4 Bricklet.
...
## Solution
A Domoticz Python plugin named **"Tinkerforge LCD 20x4 Bricklet - Lite"** enables to write characters to the LCD 20x4 display via a Domoticz text device (Type:General, SubType:Text).
At plugin start, an IP connection is established until either Domoticz stops or the plugin is disabled.
The text to be displayed on the LCD, is defined as a JSON formatted string (array with up-to 4 line items) hold by the Domoticz text device.
...
**Note:**
This is the lite version of the plugin. The plugin full version enables to use the buttons and set the configuration for the backlight and cursor via switches.

### Domoticz Devices
* Type:General, SubType:Text, Name: JSON.
...
```
cd /home/pi/domoticz/plugins/tflcd20x4lite
```
...
and Domoticz Log:
```
2020-02-14 16:08:36.002 (LCD20x4) Pushing 'CPluginMessageBase' on to queue 
2020-02-14 16:08:36.015 (LCD20x4) Processing 'CPluginMessageBase' message 
2020-02-14 16:08:36.016 (LCD20x4) Calling message handler 'onDeviceModified'. 
2020-02-14 16:08:36.016 (LCD20x4) onDeviceModified called Unit:1 (LCD20x4 - JSON),nValue=0,sValue=[{"line":1,"position":9,"clear":2,"text":"Hello World!"}] 
2020-02-14 16:08:36.017 (LCD20x4) write_lines: Unit=1,ID=84,JSON=[{"line":1,"position":9,"clear":2,"text":"Hello World!"}] 
2020-02-14 16:08:36.029 (LCD20x4) write_lines: Lines: 1 
2020-02-14 16:08:36.030 (LCD20x4) write_lines: Line=1,Position=9,Text=Hello World! 
2020-02-14 16:08:36.134 (LCD20x4) write_lines: OK
```
...
In the GUI Setup > Hardware add the new hardware "Tinkerforge LCD 20x4 Bricklet - Lite".
...
```
2020-02-14 10:23:49.483 (LCD20x4) Debug logging mask set to: PYTHON PLUGIN QUEUE IMAGE DEVICE CONNECTION MESSAGE ALL 
2020-02-14 10:23:49.483 (LCD20x4) 'HardwareID':'10' 
2020-02-14 10:23:49.483 (LCD20x4) 'HomeFolder':'/home/pi/domoticz/plugins/tflcd20x4lite/' 
2020-02-14 10:23:49.483 (LCD20x4) 'StartupFolder':'/home/pi/domoticz/' 
2020-02-14 10:23:49.483 (LCD20x4) 'UserDataFolder':'/home/pi/domoticz/' 
2020-02-14 10:23:49.483 (LCD20x4) 'Database':'/home/pi/domoticz/domoticz.db' 
2020-02-14 10:23:49.483 (LCD20x4) 'Language':'en' 
2020-02-14 10:23:49.483 (LCD20x4) 'Version':'1.0.0' 
2020-02-14 10:23:49.483 (LCD20x4) 'Author':'rwbL' 
2020-02-14 10:23:49.483 (LCD20x4) 'Name':'LCD20x4' 
2020-02-14 10:23:49.483 (LCD20x4) 'Address':'127.0.0.1' 
2020-02-14 10:23:49.484 (LCD20x4) 'Port':'4223' 
2020-02-14 10:23:49.484 (LCD20x4) 'Key':'tflcd20x4lite' 
2020-02-14 10:23:49.484 (LCD20x4) 'Mode1':'BHN' 
2020-02-14 10:23:49.484 (LCD20x4) 'Mode6':'Debug' 
2020-02-14 10:23:49.484 (LCD20x4) 'DomoticzVersion':'4.11674' 
2020-02-14 10:23:49.484 (LCD20x4) 'DomoticzHash':'91c3475ac' 
2020-02-14 10:23:49.484 (LCD20x4) 'DomoticzBuildTime':'2020-02-09 10:00:09' 
2020-02-14 10:23:49.484 (LCD20x4) Device count: 0 
2020-02-14 10:23:49.484 (LCD20x4) Creating new Device(s) 
2020-02-14 10:23:49.484 (LCD20x4) Creating device 'JSON'. 
2020-02-14 10:23:49.485 (LCD20x4) Device created: LCD20x4 - JSON 
2020-02-14 10:23:49.486 (LCD20x4) set_bricklet_configuration 
2020-02-14 10:23:49.490 (LCD20x4) Customchar: #characters defined: 5 
2020-02-14 10:23:49.491 (LCD20x4) Customchar: Index=0,Name=battery,Char=14,27,17,17,17,17,17,31 
2020-02-14 10:23:49.491 (LCD20x4) Customchar: Index=1,Name=clock,Char=31,17,10,4,14,31,31,0 
2020-02-14 10:23:49.491 (LCD20x4) Customchar: Index=2,Name=arrowdown,Char=0,4,4,4,31,14,4,0 
2020-02-14 10:23:49.491 (LCD20x4) Customchar: Index=3,Name=arrowup,Char=0,4,14,31,4,4,4,0 
2020-02-14 10:23:49.492 (LCD20x4) Customchar: Index=4,Name=nochange,Char=0,0,31,0,31,0,0,0 
2020-02-14 10:23:49.593 (LCD20x4) set_bricklet_configuration: OK 
2020-02-14 10:23:49.020 Status: (LCD20x4) Started. 
2020-02-14 10:23:49.480 Status: (LCD20x4) Initialized version 1.0.0, author 'rwbL' 
2020-02-14 10:23:49.480 Status: (LCD20x4) Entering work loop.
```
...
```
2020-02-14 10:44:00.357 (LCD20x4) Pushing 'CPluginMessageBase' on to queue 
2020-02-14 10:44:00.383 (LCD20x4) Processing 'CPluginMessageBase' message 
2020-02-14 10:44:00.386 (LCD20x4) Calling message handler 'onDeviceModified'. 
2020-02-14 10:44:00.386 (LCD20x4) onDeviceModified called: Unit 1, LCD20x4 - JSON 
2020-02-14 10:44:00.386 (LCD20x4) nValue=0,sValue=[{"line":1,"position":0,"clear":1,"text":"CPU 44.0 \u00DFC"},{"line":2,"position":0,"clear":1,"text":"RAM 29.18 %"},{"line":3,"position":0,"clear":1,"text":"DISC 69.08 %"},{"line":0,"position":14,"clear":1,"text":"\u000910:44"}] 
2020-02-14 10:44:00.386 (LCD20x4) write_lines: Unit=1,ID=84,JSON=[{"line":1,"position":0,"clear":1,"text":"CPU 44.0 \u00DFC"},{"line":2,"position":0,"clear":1,"text":"RAM 29.18 %"},{"line":3,"position":0,"clear":1,"text":"DISC 69.08 %"},{"line":0,"position":14,"clear":1,"text":"\u000910:44"}] 
2020-02-14 10:44:00.391 (LCD20x4) JSON line items: 4 
2020-02-14 10:44:00.391 (LCD20x4) Items (l,p,t,c): 1,0,CPU 44.0 ßC,1 
2020-02-14 10:44:00.393 (LCD20x4) LCD line written=1,0:CPU 44.0 ßC 
2020-02-14 10:44:00.393 (LCD20x4) Items (l,p,t,c): 2,0,RAM 29.18 %,1 
2020-02-14 10:44:00.394 (LCD20x4) LCD line written=2,0:RAM 29.18 % 
2020-02-14 10:44:00.394 (LCD20x4) Items (l,p,t,c): 3,0,DISC 69.08 %,1 
2020-02-14 10:44:00.395 (LCD20x4) LCD line written=3,0:DISC 69.08 % 
2020-02-14 10:44:00.395 (LCD20x4) Items (l,p,t,c): 0,14, 10:44,1 
2020-02-14 10:44:00.396 (LCD20x4) LCD line written=0,14: 10:44 
2020-02-14 10:44:00.498 (LCD20x4) write_lines: OK 
